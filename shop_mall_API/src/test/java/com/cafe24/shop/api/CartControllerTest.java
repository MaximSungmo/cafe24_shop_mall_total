...
public class CartControllerTest {
  ...
  public List<ProductDetailVo> test_data_product_detail() {
    ...
    ProductDetailVo detail_vo1 = new ProductDetailVo(361L, product_vo1_no, "사이즈270-1", 100L,
        "STOCK",
        40L, null);
    ProductDetailVo detail_vo2 = new ProductDetailVo(362L, product_vo2_no, "사이즈270-2", 200L,
        "STOCK",
        40L, null);
    ProductDetailVo detail_vo3 = new ProductDetailVo(363L, product_vo3_no, "사이즈270-3", 300L,
        "STOCK",
        40L, null);
    product_detail_list.add(detail_vo1);
    product_detail_list.add(detail_vo2);
    product_detail_list.add(detail_vo3);
    int key = sqlSession.insert("product.insert_product_detail", product_detail_list);
  ...
  public List<CustomerVo> test_data_customer() {
    ...
    CustomerVo vo1 = new CustomerVo(null, "성공테스트", "ksm5318@naver.com", "PASSWORD1!",
        "010-1234-1234", "M", termsofuse_vo1_no, "Y");
    CustomerVo vo2 = new CustomerVo(null, "성공테스트2", "EMAIL2@TEST.COM", "PASSWORD12!",
        "010-2222-2222", "M", termsofuse_vo2_no, "Y");
  ...
  public List<CartVo> test_data_cart() {
    CartVo cartvo1 = new CartVo(null, customer_list.get(0).getNo(),
        product_detail_list.get(0).getNo(), 1L, null, null, null);
    CartVo cartvo2 = new CartVo(null, customer_list.get(0).getNo(),
        product_detail_list.get(1).getNo(), 1L, null, null, null);
    CartVo cartvo3 = new CartVo(null, customer_list.get(0).getNo(),
        product_detail_list.get(2).getNo(), 1L, null, null, null);
...
//        accessToken = jsonParser.parseMap(resultString).get("access_toke" + "n").toString();
  ...
  public void add_cart_success_test() throws Exception {
    // 임시
    product_detail_list.get(0).setNo(349L);
  ...
  public void get_cart_list_success_test() throws Exception {
    ...
    resultActions
        ...
        .andExpect(
            jsonPath("$.data[0].product_detail_no").value(cart_list.get(0).getProduct_detail_no()))
        .andExpect(
            jsonPath("$.data[0].productDetailVo.no").value(product_detail_list.get(0).getNo()))

        .andExpect(jsonPath("$.data[1].customer_no").value(cart_list.get(1).getCustomer_no()))
        .andExpect(
            jsonPath("$.data[1].product_detail_no").value(cart_list.get(1).getProduct_detail_no()))
        .andExpect(
            jsonPath("$.data[1].productDetailVo.no").value(product_detail_list.get(1).getNo()))

        .andExpect(jsonPath("$.data[2].customer_no").value(cart_list.get(2).getCustomer_no()))
        .andExpect(
            jsonPath("$.data[2].product_detail_no").value(cart_list.get(2).getProduct_detail_no()))
        .andExpect(
            jsonPath("$.data[2].productDetailVo.no").value(product_detail_list.get(2).getNo()));
  }
