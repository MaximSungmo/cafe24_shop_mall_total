...
public class ProductControllerTest {
	...
	public void get_product_image_list_success_test() throws Exception {
		...
		ResultActions resultActions = mockMvc
			.perform(get("/api/product/"+product_list.get(1).getNo()+"/image?product_image_category_no=")
			.contentType(MediaType.APPLICATION_JSON));
	...
	public void delete_product_image_success_test() throws Exception {
		ResultActions resultActions = mockMvc
			.perform(delete("/api/product/"+product_list.get(1).getNo()+"/image/"+image_list.get(0).getNo())
			.contentType(MediaType.APPLICATION_JSON));
